...
var KTreeConfig = {
	rootIcon        : '<%=Config.Path%>/htc/images/foldericon.gif',
	openRootIcon    : '<%=Config.Path%>/htc/images/openfoldericon.gif',
	folderIcon      : '<%=Config.Path%>/htc/images/foldericon.gif',
	openFolderIcon  : '<%=Config.Path%>/htc/images/openfoldericon.gif',
	fileIcon        : '<%=Config.Path%>/htc/images/file.gif',
	iIcon           : '<%=Config.Path%>/htc/images/I.gif',
	lIcon           : '<%=Config.Path%>/htc/images/L.gif',
	lMinusIcon      : '<%=Config.Path%>/htc/images/Lminus.gif',
	lPlusIcon       : '<%=Config.Path%>/htc/images/Lplus.gif',
	tIcon           : '<%=Config.Path%>/htc/images/T.gif',
	tMinusIcon      : '<%=Config.Path%>/htc/images/Tminus.gif',
	tPlusIcon       : '<%=Config.Path%>/htc/images/Tplus.gif',
	blankIcon       : '<%=Config.Path%>/htc/images/blank.gif',
	defaultText     : 'Tree Item',
	defaultAction   : 'javascript:void(0);',
	defaultBehavior : 'classic',
	usePersistence	: false
};
alert(KTreeConfig.rootIcon);
var KTreeHandler = {
	idCounter : 0,
...
function _xmlFileLoaded(oXmlDoc, jsParentNode) {
	...
	if( oXmlDoc == null || oXmlDoc.documentElement == null) {
		...
		// if no children we got an error			liuxd×¢ÊÍ
		//if (!bAnyChildren)
