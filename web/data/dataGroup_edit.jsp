...
<body>
<form id="dataForm" name="dataForm" method="post" action="dataGroupAction.do?action=updateData" Check="true"
      Change="true">
    <table class="edit" cellspacing=1 cellpadding=3 width="95%" align=center border=0>
        <tr class="title">
            <td colspan="4"><b>专题编辑</b></td>
        </tr>
        <tr>
            <td width="15%" align="right">名称</td>
            <td><input name="name" type="text" size="30" value="<%=dataGroup.getName()%>" validType="maxLength[160]"
                       class="easyui-textbox easyui-validatebox"></td>
            <td width="15%" align="right">标题</td>
            <td><input name="title" type="text" size="30" value="<%=dataGroup.getTitle()%>" validType="maxLength[160]"
                       class="easyui-textbox easyui-validatebox"></td>
        </tr>
        <tr>
            <td width="15%" align="right">描述</td>
            <td colspan="3"><textarea id="editor_id" name="description"
                                      style="width: 800px; height: 400px;"><%=StringUtil.htmlspecialchars(dataGroup.getDescription())%></textarea>
            </td>
        </tr>
        <tr>
            <td width="15%" align="right">LOGO</td>
            <td colspan="3"><i class="fa fa-3x <%=dataGroup.getLogo()%>"></i>
                <input name="logo" type="text" size="30" value="<%=dataGroup.getLogo()%>" validType="maxLength[160]"
                       class="easyui-textbox easyui-validatebox"></td>
        </tr>
    </table>
    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="29" align="center">
                <input name="id" type="hidden" value="<%=dataGroup.getId()%>">
