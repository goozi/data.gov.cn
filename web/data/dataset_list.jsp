...
<%
	...
	Iterator it=oDataset.findPage(currPage,pageSize).iterator();
...
<body>
	<table width="95%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td height="30">
				<input type="button" name="add" value="新建" class="btn"  onClick="location.href='dataset_add.jsp';" >
				<input type="button" name="edit" value="编辑" class="btn"  onClick="editData(document.getElementsByName('idArray'),'dataset_edit.jsp?id=')"  >
...
%>
		<tr>
			...
			<td><a href="dataset_view.jsp?id=<%=dataset.getId()%>"><%=dataset.getId()%></a></td>
