...
<%
    long datasetId = req.getLong("datasetId");
    ...
    Iterator it = oDataResource.findPageByDatasetId(datasetId, currPage, pageSize).iterator();
    ...
    <tr>
        <td height="30">
            <input type="button" name="add" value="新建" class="btn"
                   onClick="location.href='dataResource_add.jsp?datasetId=<%=datasetId%>';">
            <input type="button" name="edit" value="编辑" class="btn"
                   onClick="editData(document.getElementsByName('idArray'),'dataResource_edit.jsp?id=')">
...
<table class="list" FixRow="<%=pageSize%>" cellspacing=1 cellpadding=0 width="95%" align=center border=0>
    ...
    <tr>
        ...
        <td><%=TypeApp.getName("RESOURCE_TYPE",dataResource.getResType())%>
        </td>
